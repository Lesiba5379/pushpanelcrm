        ...
        <div class="col-md-12 panel-body" style="padding-bottom:30px;">
            <div class="col-md-12">
               ...
               @endif
                ...
                {!! Form::open(['action' => ['BeaconsController@update',$beacon->id],'method' => 'POST']) !!}
                <div class="form-group form-animate-text" style="margin-top:40px !important;">
                    <input type="text" name="uuid" class="form-text" id="email" value="{{$beacon->uuid}}" required>  
                        <span class="bar"></span>
                ...
                <div class="form-group form-animate-text" style="margin-top:40px !important;">
                    ...
                    <select class="form-control" name="selectProduct[]" required>
                        <option value="Smart Beacon SB16-2" >
                            @php
                                $obj = json_decode($beacon->product);
                                echo $obj[0];
                            @endphp
                        </option>
                ...
                <div class="form-group form-animate-text" style="margin-top:40px !important;">
                     ...
                     <select id="select" class="selectpicker form-control" name="assignTo[]" required>
                        @foreach($profile as $prof)
                            <option value="{{ $prof->company_name }}">{{ $prof->company_name}}</option>
                        @endforeach 
                    </select>
                </div>
